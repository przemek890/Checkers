...
tekst_menu::tekst_menu(sf::Font& font) {
    ...
    if(resolution_mode == 2) this->text_game.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_options.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_credits.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_exit.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_lg.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_board.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_pawns.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_game_mode.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_return.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_confirm.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_pvp.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_pve.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->authors.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->prze.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->jul.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->kuba.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_attr.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_arch.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_rank.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_acca.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->text_man_your_acc.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->fs_title.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->fs_log.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->fs_pas.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->fs_ex.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->fs_con.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->fs_na.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->na_ret.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->na_tit.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->login.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->password.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->chan_log.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->chan_pass.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->ranking.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->position.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->nickname.setScale(0.5,0.5);
    ...
    if(resolution_mode == 2) this->point.setScale(0.5,0.5);
